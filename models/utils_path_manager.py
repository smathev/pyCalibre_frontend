...
class PathManager:
    ...
    def find_base_dir():
        ...
        while not os.path.isfile(os.path.join(current_dir, 'app.py')):
            parent_dir = os.path.dirname(current_dir)
            if parent_dir == current_dir:
                raise FileNotFoundError("Could not find 'app.py' in any parent directories from the current script location.")
